...
const toursdata={
    "Foreign":[
    
        {
            ...
            info:"The glacial lakes in Canada's first national park have some of the bluest water you've ever seen. Even if you're not particularly outdoorsy, you can still admire the views from one of the cozy and luxurious lakeside lodges throughout the park.",
        ...
        },
        {
            ...
            info:"Head west from Melbourne on this coastal drive to see everything from the famous 12 Apostle rock formations, to koalas in Great Otway National Park as well as the charming seaside town of Lorne.",
        ...
        },
        {
            ...
            info:"All of the Greek islands are undeniably beautiful, but head to the hillside town of Oia for some of the best views of the bright blue Aegean Sea.",
        ...
        },
        {
            id:4,
            name:"Switzerland",
            info:"Switzerland is known for its breathtaking natural beauty. The Swiss Alps offer world-class skiing and hiking opportunities, and the country's numerous lakes, such as Lake Geneva and Lake Lucerne, are famous for their crystal-clear waters. ",
        ...
        },
        {
            id:5,
            name:"Tokyo,Japan",
            info:"Tokyo is a dynamic and multifaceted city that offers a captivating blend of tradition and modernity. It's a place where ancient rituals coexist with cutting-edge technology, making it a truly unique destination for travelers.",
        ...
        },
        {
            id:6,
            name:"New York,USA",
            info:"New York City is a vibrant, dynamic, and culturally rich metropolis with something for everyone. Its iconic landmarks, diverse neighborhoods, and cultural attractions make it a top destination for travelers from around the globe.",
        ...
        },
        {
            ...
            info:"Known all over the world as the home of Hollywood and its glittering movie stars, LA is the hub of creativity and legends. It has been bestowed with natural beauty, sweeping golden beaches, architectural gems, film studios, and culinary diversity; making the American city of dreams unlike anything you have seen.",
            image:"https://hblimg.mmtcdn.com/content/hubble/img/Los_Angeles/mmt/activities/m_Los%20Angeles_4-min_l_667_1000.jpg",
        },
        {
            id:8,
            name:"Dubai",
            info:"A mix of the modern living and traditional Arabic culture, Dubai is all things glittery with luxury malls, charming souks, cutting-edge clubs, gourmet restaurants and old-world eateries.",
            image:"https://hblimg.mmtcdn.com/content/hubble/img/new_dest_imagemar/mmt/activities/m_Dubai_2_l_800_1200.jpg",
        },
        {
            id:9,
            name:"Singapore",
            info:"A melting pot of cultures, Singapore is a cosmopolitan city with a vibrant shopping, food, entertainment and nightlife scene. It is also deep-rooted in history and tradition.",
